# Generated by Django 2.2.16 on 2021-08-03 12:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=8, verbose_name='项目名称')),
                ('code', models.CharField(max_length=8, verbose_name='项目编码')),
                ...
                ('dept', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='project_dept', to='permission.Dept', verbose_name='项目所属部门')),
                ('person', models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='project_person', to=settings.AUTH_USER_MODEL, verbose_name='项目负责人')),
            ],
            options={
                'verbose_name': '项目管理',
