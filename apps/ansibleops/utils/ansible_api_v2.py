...
from conf.env import REDIS_HOST, REDIS_PASSWORD,REDIS_PORT, ansible_remote_user, ansible_result_redis_db
...
class RedisCallBack(CallbackBase):
    def __init__(self, task_id):
        ...
        self.id = task_id
        self.results = []
        self.r = redis.Redis(host=REDIS_HOST, port=REDIS_PORT, password=REDIS_PASSWORD, db=ansible_result_redis_db)
